          ...
          children: docs.asMap().entries.map((entry) {
            ...
            return GestureDetector(
              onTap: () {
                ...
                setState(() => _expanded = expanded ? -1 : i);
...
class _ReplyButton extends StatelessWidget {
  final String email;
  const _ReplyButton({required this.email});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        HapticFeedback.lightImpact();
        // Copy email to clipboard — launching mailto from admin is most reliable
      ...
      child: Container(
        ...
        child: Row(mainAxisSize: MainAxisSize.min, children: [
          const Icon(Icons.reply_rounded, color: AppColors.accent, size: 15),
          const SizedBox(width: 6),
          Text('Copy email to reply',
              style: GoogleFonts.montserrat(
